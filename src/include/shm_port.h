 ...
 * @param signal Signal to send.
 */
void shm_port_send_signal_to_port(shm_port_t *p, int id, int signal);
 ...
 */
void shm_port_set_pid(shm_port_t *p, int id, pid_t pid);
 ...
 */
void shm_port_set_coordinates(shm_port_t *p, int id, struct coord coord);
 ...
 */
void shm_port_set_docks(shm_port_t *p, int id, int n);
 ...
 */
struct coord shm_port_get_coordinates(shm_port_t *p, int id);
