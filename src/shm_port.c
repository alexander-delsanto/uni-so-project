...
void port_shm_set_dump_expired(shm_port_t *p, int port_id, int id, int quantity)
{
...
void port_shm_set_dump_received(shm_port_t *p, int port_id, int id,
				int quantity)
{
...
void port_shm_set_dump_present(shm_port_t *p, int port_id, int id, int quantity)
{
	p[port_id].dump_present[id] += quantity;
	p[port_id].dump_cargo_available += quantity;
}

void port_shm_set_dump_shipped(shm_port_t *p, int port_id, int id, int quantity)
{
...
int port_shm_get_dump_present_by_id(shm_port_t *p, int port_id, int id){return p[port_id].dump_present[id];}
int port_shm_get_dump_received_by_id(shm_port_t *p, int port_id, int id){return p[port_id].dump_received[id];}
int port_shm_get_dump_expired_by_id(shm_port_t *p, int port_id, int id){return p[port_id].dump_expired[id];}
int port_shm_get_dump_sent_by_id(shm_port_t *p, int port_id, int id){return p[port_id].dump_sent[id];}
